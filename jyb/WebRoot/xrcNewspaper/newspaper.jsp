...
<html>
  <head>
	...
	<style type="text/css">
		*{ margin:0; padding:0; list-style: none;}
		...
		#news1 ul li a{ width: 300px; display:block; height:27px; font-size: 12px;}
  ...
  <body onload="showPart('${partid}');">
    ...
    <div style="width: 1000px; height: 600px; margin: 0 auto; position: relative;clear:left;">
			...
			<div id="content" style="width: 520px; height:580; float: right; text-align: center;">
				<div class="nav">
				...
				<div style="width: 520px; height:480px; margin-top:20px;">
					<div id="news1" style="background:#efefef; width: 300px; height: 480px; margin-right:14px; float: left;"> 
					...
					<div id="news2" style="background:#efefef; width: 200px; height: 480px; float: right;">
						<div style=" color:#ffffff; font-family:’微软雅黑‘; background:#3399cc; width: 200px; line-height: 30px;">
							本期版面
						</div>
		 ...
		 <div class="foot">
	   		<div class="foot_1">
				...
				<div style="float: right;margin-right: 200px;line-height: 62px; ">
        			<a href="xrcNewspaperCtrl/toNewspaper" style="color: rgb(213,213,213); font-size:12px;">返回顶部</a>
        		</div>
	   		</div>
	   		<div class="foot_2">
	   			<div class="foot_2_1">
			...
			$.ajax({   
	           ...
	           success:function(data){   //data:服务器端返回给浏览器端的数据
	              ...
	              var admin=data.name;
	           	  ...
	           	  content1.innerHTML = "<h1 style='line-height:50px; margin-top:30px; text-align:center;'>"+parttitle+"</h1><p style=' line-height:40px; background:#3399cc; color:#ffffff; font-size:12px;'>发布者："+admin+"&nbsp;&nbsp;&nbsp;&nbsp;上传时间:"+uploadtime+"&nbsp;&nbsp;&nbsp;&nbsp;点击量:"+hits+"</p>"+content;
...
//		alert(pagenum);
		...
		if(parseInt(editionnum)> parseInt(maxEditionnum)){
	    	...
	    	x.method="post";
	    	x.action="xrcNewspaperCtrl/toNewspaper";
	    	x.submit();
    	}
	}
</script>