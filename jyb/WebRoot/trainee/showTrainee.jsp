...
<html>
  ...
  <body>
  	<div id="head">
		<div id="head_nag">
			...
			<ul class="head_nag_u">
				...
				<li class="head_nag_u_message">
					<a href="message/queryMessagePage">
						留言
					</a>
				</li>
				<%
	...
	<div style="width:100%;background: rgba(51,153,204,0.18); border:1px solid rgb(213,213,213);">
	<div id="contents">
	    <div id="xinxizixun">
	        <div id="left">
	            <div class="xinxi1">
	            ...
	            <ul class="xinxi5">
	                ...
	                <li class="list" style="background:#3399CC;">
	                	<a href="trainee/queryTraineeLike" style=" color:#ffffff; ">实习生简介</a>
	                </li>
	            </ul>
	            <ul class="xinxi6">
	                <li class="x2">
	        ...
	        <div id="right">
	            <div class="top">
	                ...
	                <ul>
	                    ...
	                    <li class="tex">实习生简介</li>
	                </ul>
	            </div>
		 		<div class="out">
		 			<form id="turnPagefm" action="trainee/queryTraineeLike">
		 		  		<div style="margin-top: 20px; font-size: 12px; padding-left: 25px;">
			 		     	&nbsp;姓名：       <input type="text" name="name" style="margin-right: 20px; width: 140px; line-height: 25px; border: 1px solid rgb(203,204,204);" value="${name }" />
			 		     	实习地点：<input type="text" name="city" style="margin-right: 20px; width: 140px; line-height: 25px;border: 1px solid rgb(203,204,204);"  value="${city }" />
			 		     	标题：        <input type="text" name="title" style="margin-right: 20px; width: 140px; line-height: 25px;border: 1px solid rgb(203,204,204);" value="${title }"  /><br />
			 		     	&nbsp;专业：       <input type="text" name="major" style="margin-right: 20px; width: 140px; line-height: 25px; margin-top: 20px;border: 1px solid rgb(203,204,204);" value="${major }"  />			 		     	
			 		     	实习单位：<input type="text" name="company" style="margin-right: 20px; width: 140px; line-height: 25px;border: 1px solid rgb(203,204,204);" value="${company }"  />
			 		     		   <input type="submit" value="查找" style="padding: 5px 5px; background: #3399cc; color: #ffffff;" />	 		    
		 		  		</div>
		 		  		<c:forEach items="${traineeList }" varStatus="status" var="item"> 
		 		  			<div id="graduate" >
	                        	<dl>	                           
	                                <dd>
	                                    <div class="img">
	                                        <a href="trainee/showOneTrainee?tid=${item.tid }"  >
				                            	<img alt="暂时没有照片" src="${item.photo }" title="${item.name }"/>
				                        	</a>
	                                    </div>
	                                </dd>
	                                <dt>
	...
	<div class="foot">
	   	<div class="foot_1">
			...
			<div style="float: right;margin-right: 200px;line-height: 62px; ">
        		<a href="trainee/queryTraineeLike" style="color: rgb(213,213,213); font-size:12px;">返回顶部</a>
        	</div>
	   	</div>
	   	<div class="foot_2">
	   		<div class="foot_2_1">
