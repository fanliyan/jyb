...
<!--    这里加载的语言文件会覆盖你在配置项目里添加的语言类型，比如你在配置项目里配置的是英文，这里加载的中文，那最后就是中文-->
  ...
  <body>
    <div style="border: 1px solid red; width: 1000px; height: 680px; margin-right: 2px;">
			...
			<div style="border: 1px solid red; width: 520px; height: 680px; float: right;">
				<form id="form1">
					标题:<input type="text" name="parttitle" id="parttitle" ><br/>
						<input type="hidden" name="partid" id="partid" >
						<script id="editor" name="editor" type="text/plain" style="width:520px;height:500px;" >
						</script>
...
<script type="text/javascript">
	...
	function doSubmit(){
		...
		if(partid != ""){
			...
			$.ajax({   
	           url:'newspaperCtrl/updateNewspaperPart',   
	           type:'post',   
