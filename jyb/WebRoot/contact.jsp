	        ...
	        <div id="left">
	            ...
	            <ul class="xinxi6">
	                ...
	                <li class="list" style="background:#3399CC;">
	                	<a href="contact.jsp" style=" color:#ffffff; ">联系我们</a>
	                </li>
	                <li class="list" >
			 	...
			 	<div class="out">
			         <div class="trainee_right">
			              ...
			              <div class="content" style=" margin-left: 50px;">
				              <p>新闻热线：<b>0431-85250402</b></p><br>
				              <p>投稿邮箱：<b>ccdxjyb@163.com</b></p><br>
				              <p>地址：<b>吉林省长春市朝阳区卫星路6543号长春大学第三教学楼501室</b></p><br>
				              <p>邮编：<b>130022</b></p><br>
				              <p>新浪微博：<b>长春大学就业报</b></p><br>
				              <p>
				              	微信公众平台：<b>就业、报</b><br><br>
				              	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img  style="width: 200px;height: 200px;" alt="loading……" src="images/jybWeixin.jpg">
				              </p>
			              </div>
			         </div>
			    </div>
      	...
      	<div class="foot">
	   		<div class="foot_1">
				...
				<div style="float: right;margin-right: 200px;line-height: 62px; ">
        			<a href="contact.jsp" style="color: rgb(213,213,213); font-size:12px;">返回顶部</a>
        		</div>
	   		</div>
	   		<div class="foot_2">
	   			<div class="foot_2_1">
