...
<html>
  <head>
	...
	<link rel="stylesheet" type="text/css" href="./css/jiuyedetail.css">
  </head>
	        ...
	        <div id="right">
	            <div class="top">
	                ...
	                <ul>
	                    ...
	                    <li class="tex">就业信息内容</li>
	                </ul>
	            </div>
			    <div class="out">
			      	
			         <div class="jiuye_right">
			             <h2 class="title">${jy.title }</h2>
			             <div class="publisher" style="font-size: 12px;">
			             	发布者：${jy.aname } &nbsp;&nbsp;&nbsp;发布时间：${jy.time } &nbsp;&nbsp;浏览量： ( ${jy.view_num } )
			             </div>
