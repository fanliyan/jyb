	        ...
	        <div id="left">
	            ...
	            <ul class="xinxi2">
	                ...
	                <li class="list" style="background:#3399CC;">
	                	<a href="xrcNewspaperCtrl/showNewspaper"  style=" color:#ffffff;">新人才报</a>
	                </li>
	            </ul>
	            <ul class="xinxi3">
	                <li class="x2">
			           ...
			           <div class="in">   
				           <ul>
				             ...
				             <div style="width: 165px; height: 210px; float: left; border:1px solid rgb(204,204,204);box-shadow: 2px 0 2px #cccccc;">
				                <a href="xrcNewspaperCtrl/toNewspaper?editionnum=${item.editionnum }" >
	 ...
	 <div class="foot">
	   		<div class="foot_1">
				...
				<div style="float: right;margin-right: 200px;line-height: 62px; ">
        			<a href="xrcNewspaperCtrl/showNewspaper" style="color: rgb(213,213,213); font-size:12px;">返回顶部</a>
        		</div>
	   		</div>
	   		<div class="foot_2">
	   			<div class="foot_2_1">
