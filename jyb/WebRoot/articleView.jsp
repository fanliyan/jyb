	    ...
	    <div id="xinxizixun">
	        <div id="left">
	            ...
	            <ul class="xinxi4">
	                ...
	                <li class="list"  style="background:#3399CC;"><a href="javascript:void(0)" style=" color:#ffffff; ">须知正文</a></li>
	            </ul>
	            <ul class="xinxi5">
	                <li class="x2">
	                    <div class="d1"><img src="images/xinxiimg.png"></div>
	        ...
	        <div id="right">
	            <div class="top">
	                ...
	                <ul>
	                    ...
	                    <li class="tex">须知正文</li>
	                </ul>
	            </div>
				<div style="font-size: 12px;">
					<div id="articleTitle">${title}</div>
					<div id="articleDate">发布者：${name }&nbsp;&nbsp;&nbsp;&nbsp;发布日期：${time}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;浏览次数：${view_num}</div>
					<div id="atticleConnect" style=" margin-left: 45px; overflow-y: scroll; height: 385px;">${connect}</div>
				</div>
			</div>
		</div>
	</div>
